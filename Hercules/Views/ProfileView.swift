...
struct ProfileView: View {
                    ...
                    metaItem("Cinsiyet") {
                        Menu {
                            ...
                            HStack(spacing: 4) {
                                ...
                                Lucide(sf: "chevron.up.chevron.down", size: 7)
    ...
    // MARK: - Sistem (AI + iCloud senkronu)
...
struct ProfileAppearancePane: View {
    ...
    private struct PreviewColors {
        ...
        static let dark = PreviewColors(
            bg: Charcoal.bg, card: Charcoal.card,
            text: Charcoal.paper, sub: Charcoal.text2,
